...
/*Define start pin*/
#define LCD_START_PIN GPIO_PIN0

/* Register Select */
#define LCD_RS_PORT   GPIO_PORTC
#define LCD_RS_PIN    GPIO_PIN13

/* Enable */
#define LCD_EN_PORT   GPIO_PORTC
#define LCD_EN_PIN    GPIO_PIN14

/* Read / write  */
#define LCD_RW_PORT   GPIO_PORTC
#define LCD_RW_PIN    GPIO_PIN15
 ...
 */
#define MODE  EIGHT_BIT_CONNECTION
